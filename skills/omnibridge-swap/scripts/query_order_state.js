...
async function queryOrderState(params) {
    const API_ENDPOINT = 'https://api.omnibridge.pro/api/v2/queryOrderState';

    // Validate required parameters
    const requiredParams = ['equipmentNo', 'sourceType', 'orderId'];
