...
async function submitDepositHash(params) {
    const API_ENDPOINT = 'https://api.omnibridge.pro/api/v2/modifyTxId';

    // Validate required parameters
    const requiredParams = ['orderId', 'depositTxid'];
    ...
    try {
        ...
        if (response.resCode === '800') {
            return {
                ...
                data: response.data // Should be 'SUCCESS'
            };
        } else {
            return {
                status: 'error',
