...
async function queryCoinList(params) {
    const API_ENDPOINT = 'https://api.omnibridge.pro/api/v1/queryCoinList';

    // Validate required parameters
    const requiredParams = ['sourceFlag'];
    ...
    if (params.supportType) {
        payload.supportType = params.supportType;
    }
    if (params.mainNetwork) {
        payload.mainNetwork = params.mainNetwork;
    }
